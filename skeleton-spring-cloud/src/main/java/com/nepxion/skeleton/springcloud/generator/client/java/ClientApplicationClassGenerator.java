...
public class ClientApplicationClassGenerator extends SkeletonJavaGenerator {
    public ClientApplicationClassGenerator(String generatePath, String projectType, String prefixTemplatePath, String reducedTemplatePath, SkeletonProperties skeletonProperties) {
        super(generatePath, projectType, prefixTemplatePath, reducedTemplatePath, ClientApplicationClassGenerator.class, skeletonProperties);
    }
